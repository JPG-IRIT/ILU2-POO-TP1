...
//	MQ1 : définition de la classe static nested Marché
...
//	MQ8 : La classe interne est private static, toutes les méthodes sont private
...
//	FIN TP1
	...
	// TP1 Exceptions
	public String afficherVillageois() throws VillageSansChefException { // rajoute throws
		// rajoute
		if (chef == null) {
